...
- **別ウィンドウ表示**：ヘッダーの ⧉ ボタンで独立したウィンドウに切り替わります（サイドパネルは閉じます）。位置もサイズも自由で、Chrome以外のアプリに貼り付けるときも手前に置いておけます
...
- ヘッダーに ⧉ ボタンを追加。押すと独立したウィンドウに切り替わります（位置・サイズを自由に変えられます）。同じものが2つ並ばないよう、切り替え時にサイドパネルは閉じます
